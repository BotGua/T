...
### Cara Installnya
Script ini di modifikasi sama saya sendiri Rifky.
```bash
...
> git clone https://github.com/BotGua/T
> cd T
...
## Note
BOT INI KHUSUS HP/TERMUX DOANG YAH,JIKA MAU RE-UPLOAD CANTUMKAN NAMA SAYA (RIFKY AKBAR)
